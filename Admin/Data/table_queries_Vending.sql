...
CREATE TABLE IF NOT EXISTS inventory (
    ...
    FOREIGN KEY (vd_inventory_vending_machine_id) REFERENCES vending_machine(vd_vending_machine_ID)
);
...
CREATE TABLE IF NOT EXISTS invoice (
    ...
    FOREIGN KEY (vd_invoice_vending_machine_id) REFERENCES vending_machine(vd_vending_machine_ID)
);
